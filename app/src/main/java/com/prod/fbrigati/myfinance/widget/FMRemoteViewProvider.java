        ...
        return new RemoteViewsFactory() {
            ...
            public RemoteViews getViewAt(int i) {
                ...
                RemoteViews views = new RemoteViews(getPackageName(),
                        com.prod.fbrigati.myfinance.R.layout.widget_item_budget);
                ...
                views.setTextViewText(com.prod.fbrigati.myfinance.R.id.widget_amount_spent_category,
                        text.toString());
                views.setProgressBar(com.prod.fbrigati.myfinance.R.id.widget_progbar,
